...
execute as @s run give @s zombie_zero 1

#Give player a specific item
execute as @s run give @s ..0 1

#Give player a specific item
execute as @s run give @s zombie_head{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:-10,Slot:head,Name:"generic.attack_damage",UUID:[I;-122018,29275,212527,-58550]},{AttributeName:"generic.armor",Amount:8,Slot:head,Name:"generic.armor",UUID:[I;-122018,29375,212527,-58750]}],display:{Name:'[{"text":"Zombie Head","italic":false}]',Lore:['[{"text":"brains","italic":false}]']},Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1},{id:feather_falling,lvl:10},{id:projectile_protection,lvl:5}],HideFlags:3} 1
