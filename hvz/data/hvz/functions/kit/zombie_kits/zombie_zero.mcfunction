...
execute as @s run item replace entity @s armor.head with zombie_head{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:-10,Slot:head,Name:"generic.attack_damage",UUID:[I;-122018,29275,212527,-58550]},{AttributeName:"generic.armor",Amount:8,Slot:head,Name:"generic.armor",UUID:[I;-122018,29375,212527,-58750]}],display:{Name:'[{"text":"Zombie Head","italic":false}]',Lore:['[{"text":"brains","italic":false}]']},Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1},{id:feather_falling,lvl:10},{id:projectile_protection,lvl:5}],HideFlags:3}
...
execute as @s run give @s wooden_sword{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:13,Slot:mainhand,Name:"generic.attack_damage",UUID:[I;-122018,20330,2232,-40660]},{AttributeName:"generic.attack_speed",Amount:-0.6,Slot:mainhand,Operation:1,Name:"generic.attack_speed",UUID:[I;-122018,20430,2232,-40860]}],display:{Name:'[{"text":"Pool Noodle","italic":false}]',Lore:['[{"text":"bonk","italic":false}]','[{"text":"","italic":false}]','[{"text":"When in Main Hand:","italic":false,"color":"gray"},{"text":"","italic":false,"color":"dark_purple"}]','[{"text":" 4 Attack Damage","italic":false,"color":"dark_green"}]','[{"text":" 1.6 Attack Speed","italic":false,"color":"dark_green"}]']},Enchantments:[{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1}],HideFlags:3} 1
