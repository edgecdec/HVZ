...
execute as @p if entity @s[team=HVZZombie,tag=perkRock] run item replace entity @p armor.legs with leather_leggings{display:{"color":1640448,Name:'[{"text":"Invincible Athletic Pants"}]'},Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.knockback_resistance",Name:"generic.knockback_resistance",Slot:"legs",Amount:1,Operation:1,UUID:[I;1007165276,1025448352,1007673513,1540559398]}]}
