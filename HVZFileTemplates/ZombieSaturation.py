...
addMobsToTeamsStr = "function hvz:control/add_mobs_to_teams\n"
updateKillsStr = "function hvz:control/kill_update_helper\n"
...
def generateZombieSaturationFile():
    with open(f"{CONTROL_FILE_PATH}zombie_saturation.mcfunction", 'w') as outfile:
        ...
        outfile.write(addMobsToTeamsStr)
        outfile.write(updateKillsStr)
