...
with open(f'{KIT_FILE_PATH_OLD}code_generated_kit_logic.mcfunction', 'w') as kitOutfile:
    ...
    for i in range(len(data)):
        ...
        with open(f'{KIT_FILE_PATH_OLD}{curFileName}', 'w') as curOutfile:
...
with open(f"{KIT_FILE_PATH_OLD}remove_code_generated_tags_primary.mcfunction", 'w') as curOutfile:
...
with open(f"{KIT_FILE_PATH_OLD}remove_code_generated_tags_secondary.mcfunction", 'w') as curOutfile:
