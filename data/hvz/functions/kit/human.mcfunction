...
execute as @p if entity @s[team=HVZHuman,tag=!ghost] run item replace entity @p armor.chest with minecraft:golden_chestplate{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.armor",Amount:14,Slot:chest,Name:"generic.armor",UUID:[I;-121516,14894,171924,-29788]},{AttributeName:"generic.armor_toughness",Amount:8,Slot:chest,Name:"generic.armor_toughness",UUID:[I;-121516,14994,171924,-29988]}],display:{Name:'[{"text":"Armband","italic":false}]'},Enchantments:[{id:binding_curse,lvl:1}]} 1
